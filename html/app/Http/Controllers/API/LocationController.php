...
class LocationController extends BaseController
{
    ...
    {
        $countryList = array("Afghanistan", "Albania", "Algeria", "American Samoa", "Angola", 
        ...
        "Cote d'Ivoire", "Croatia", "Cuba", "Cyprus", "Czeck Republic", "Denmark", "Djibouti",
        ...
        "Hong Kong", "Howland Island", "Hungary", "Iceland", "India", "Indonesia", "Iran",
        "Iraq", "Ireland", "Ireland, Northern", "Israel", "Italy", "Jamaica", "Jan Mayen", 
        "Japan", "Jarvis Island", "Jersey", "Johnston Atoll", "Jordan", "Juan de Nova Island",
        "Kazakhstan", "Kenya", "Kiribati", "Korea, North", "Korea, South", "Kuwait", "Kyrgyzstan", 
        "Laos", "Latvia", "Lebanon", "Lesotho", "Liberia", "Libya", "Liechtenstein", "Lithuania", 
        "Luxembourg", "Macau", "Macedonia, Former Yugoslav Republic of", "Madagascar", "Malawi", 
        "Malaysia", "Maldives", "Mali", "Malta", "Man, Isle of", "Marshall Islands", "Martinique", 
        ...
        "Philippines", "Pitcaim Islands", "Poland", "Portugal", "Puerto Rico", "Qatar", "Reunion", 
        "Romainia", "Russia", "Rwanda", "Saint Helena", "Saint Kitts and Nevis", "Saint Lucia", 
        "Saint Pierre and Miquelon", "Saint Vincent and the Grenadines", "Samoa", "San Marino", 
        "Sao Tome and Principe", "Saudi Arabia", "Scotland", "Senegal", "Seychelles", "Sierra Leone",
        ...
        "Uruguay", "USA", "Uzbekistan", "Vanuatu", "Venezuela", "Vietnam", "Virgin Islands", "Wales", 
        "Wallis and Futuna", "West Bank", "Western Sahara", "Yemen", "Yugoslavia", "Zambia", "Zimbabwe");


        if (count($countryList) > 0) {
            return $this->sendResponse($countryList, 'Country list served');
        }else{
    ...
    public function state( Request $request)
	{
        ...
        $index = array_search(ucfirst(strtolower($request->country)), $countryList) + 1;
        $stateObject = $s_a[$index];
        $stateList = explode("|",$stateObject);
        sort( $stateList );

        //STATE LIST FOUND FOR GIVEN PAYLOAD
        if (count($stateList) > 0) {
            return $this->sendResponse($stateList, 'State list served');
        }else{
            return $this->sendError('Data not found');
        }
    }
